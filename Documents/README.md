...
Follow the guides in order. Each goal builds on the Fabric items and tables
created in the preceding goal.

| Step | Guide | Deliverable |
|---|---|---|
| 0 | [Introduction](Fabric%20Hackathon%20-%200%20-%20Intro.md) | Understand the scenario, prerequisites, and safety requirements |
| 0 | [Architecture](Fabric%20Hackathon%20-%200%20-%20Architecture.md) | Review the source schemas, OneLake design, and target model |
...
facilitator; no environment-specific server or database names are committed.
